            ...
            children: [
              ...
              Obx(() {
                return Container(
                  ...
                  width: 320.0,
                  height:
                      screenHeight(1.0911111), // ارتفاع ثابت بدلاً من Infinity
                  child: ListView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        return CustomCardAppointment(
                          ...
                          id: booked[index][0],
                          date: '${booked[index][1]}',
                          starttime: '${booked[index][2]}',
                          confirmed: '${booked[index][3]}',
                          patient: '${booked[index][4]}',
                          service: '${booked[index][5]}',
                          doctor: '${booked[index][6]}',
                        );
                      }),
                );
              }),
